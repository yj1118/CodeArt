...
namespace CodeArt.ServiceModel
{
    ...
    internal class ServiceRouter
    {
        ...
        {
            _direct = ServiceModelConfiguration.Current.Client.Direct;
        }
        ...
        private ServiceAddressTable DownloadAddressTable(string serviceNamespace, DTObject identity)
        {
            ...
            var routerAddresses = ServiceModelConfiguration.Current.Client.GetAddresses(serviceNamespace);
            ...
            var response = ServiceProxy.Invoke(request, routerAddress);
            response.TryCatch();
