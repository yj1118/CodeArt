...
namespace CodeArt.DomainDriven
{
    ...
    internal static class RemotePortal
    {
        ...
        private static IRemoteService _implement;

        private static IRemoteService Implement
        {
            get
            {
                if (_implement == null)
                    _implement = DomainDrivenConfiguration.Current.RemotableConfig.GetRemoteService() ?? _implementByRegister;
                return _implement;
            }
        }


        private static IRemoteService _implementByRegister;
