...
namespace CodeArt.DomainDriven.Extensions {
    ...
    internal class Strings {
        ...
        /// <summary>
        ///   查找类似 Start time cannot be later than end time 的本地化字符串。
        /// </summary>
        internal static string StartTimeLaterEndTime {
            get {
                return ResourceManager.GetString("StartTimeLaterEndTime", resourceCulture);
            }
        }
    }
}
