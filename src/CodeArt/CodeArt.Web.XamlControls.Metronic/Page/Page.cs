...
namespace CodeArt.Web.XamlControls.Metronic
{
   [TemplateCodeFactory("Template",typeof(PageTemplateCodeFactory))]
    public class Page : CodeArt.Web.WebPages.Xaml.Controls.Page
    {
        ...
        {
            base.OnLoad();
            var rootMenu = WebPageContext.Current.GetQueryValue<string>("rootMenu", string.Empty);
            if (!string.IsNullOrEmpty(rootMenu)) this.RootMenu = rootMenu; //支持以url参数形式设置rootMenu
        }
    }
}
