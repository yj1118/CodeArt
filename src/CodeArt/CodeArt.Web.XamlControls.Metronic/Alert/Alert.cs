...
namespace CodeArt.Web.XamlControls.Metronic
{
    ...
    public class Alert : ContentControl
    {
        ...
        public static readonly DependencyProperty ActionsProperty = DependencyProperty.Register<UIElementCollection, Alert>("Actions", () => { return new UIElementCollection(); });
