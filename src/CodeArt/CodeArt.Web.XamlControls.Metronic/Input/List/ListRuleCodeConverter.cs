...
{
    public class ListRuleCodeConverter : RuleCodeConverter
    {

        protected override void FillRulesCode(object d, StringBuilder code)
        {
            var target = d as List;
            code.Append("listItemsValidate:true,");
        ...
        protected override void FillMessagesCode(object d, StringBuilder code)
        {
            ...
            code.AppendFormat("listItemsValidate:'{0}',", string.Format(Strings.ListItemsError, label));
        ...
        public readonly static ListRuleCodeConverter Instance = new ListRuleCodeConverter();
    }
}