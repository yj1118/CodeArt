...
namespace CodeArt.Web.XamlControls.Metronic
{
    public class Input : Control
    {
        ...
        /// 是否禁用状态
        /// </summary>
        public static readonly DependencyProperty DisabledProperty = DependencyProperty.Register<bool, Input>("Disabled", () => { return false; });
        ...
        {
            return this.Combine(base.GetActionElement(actionName) , this.Prepend.GetActionElement(actionName) , this.Append.GetActionElement(actionName));
        }
