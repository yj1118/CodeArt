...
namespace CodeArt.Web.XamlControls.Metronic
{
    ...
    public class LoginPage : CodeArt.Web.WebPages.Xaml.Controls.Page
    {
        ...
        protected virtual IScriptView Login(ScriptView view)
        {
            ...
            {
                view.WriteCode("loginForm.proxy().showError('" + Strings.WrongUserNamePassword + "');");
            }
            return view;
        }
        ...
        private IScriptView Register(ScriptView view)
        {
            ...
            if (result.Success)
            {
                ...
                view.WriteCode("$$('#loginForm').show('" + Strings.OperationSucceededPleaseLogin + "');");
            }
            else
            {
                view.WriteCode("registerForm.proxy().showError('" + result.Message + "');");
            }
            return view;
        }
