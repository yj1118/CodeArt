...
namespace Module.Minio
{
    ...
    public class FileStorage
    {
        ...
        private FileStorage()
        {
            ...
            string bucket = ConfigurationManager.AppSettings[configBucket];
            if (bucket == null) throw new ApplicationException(string.Format("NotSetupMinio", configBucket));
        }
        ...
        public static string GetPath(string key,string root)
        {
            ...
            if (folder == null) throw new ApplicationException(string.Format("CannotWriteTemporaryFile", configName));
