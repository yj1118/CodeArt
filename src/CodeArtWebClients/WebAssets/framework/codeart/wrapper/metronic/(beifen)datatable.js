$$.createModule("Wrapper.metronic.datatable", function (api, module) {
            ...
            o.load = function (p) {
                ...
                f.success = function (r) {
                    ...
                    if (r.page && (r.page.index > 0 && r.page.index >= r.page.pageCount)) { //超出最大页码，那么直接读取第1页(下标为0)
                        ...
                        o.execEvent("onload", [o, r]);
                }
                initAsyncEvent(o, f);
                var url = o.para("url") || window.location.href;
            ...
            function bindTable(o, d) {
                ...
                var config = {
                    ...
                    "language": {
                        ...
                        "info": "显示第 _START_ 到 _END_ 条 共计 _TOTAL_ 项",
                        "emptyTable": "暂无数据",
                        "sInfoEmpty": "共计 0 项",
                ...
                j.find('.group-checkable').on('change', function () {
                ...
                options = $.extend(true, {
                    ...
                    dataTable: {
                        ...
                        "language": { // language settings
                            ...
                            "info": "<span class='seperator'>&nbsp;</span>共计 _TOTAL_ 项",
                            "infoEmpty": "",
                            "emptyTable": "暂无数据",
                            "zeroRecords": "没有找到匹配的数据",
                            "paginate": {
                        ...
                        "ajax": { // define ajax settings
                            ...
                            "data": function (data) { // add request parameters before submit
                                var pageSize = data.length, pageIndex = parseInt(data.start / pageSize), newData = {};
                                var prevData = $$(tableContainer).data;
                                //以下重定位，可以解决页尺寸改变时引出的页码BUG
                                if (prevData && prevData.page.size != pageSize) {
    ...
    $$.wrapper.metronic.datagrid = function () {
        this.give = function (o) {
            $o.callvir(this, $component.ui, "give", o);
            var id = o.getJquery().attr("id"), _table = $("#" + id + "_table"), rowTemplate = _table.find("tbody > tr").first();
            ...
            o.load = function () {
                if (o.table) { o.table.destroy(); } //一定要先破坏旧表格
                var grid = new Datatable(), ajaxUrl = (o.para("url") || location.pathname) + $.query.set("$PostAction", o.para("action"));
                var config = {
                    src: _table,
