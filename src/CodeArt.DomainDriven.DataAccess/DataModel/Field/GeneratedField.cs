...
namespace CodeArt.DomainDriven.DataAccess
{
    ...
    internal sealed class GeneratedField : ValueField
    {
        ...
        internal abstract class PropertyBase : DomainProperty
        {
            public PropertyBase(Type ownerType, Type propertyType, string name)
            {
        ...
        private class GuidProperty : PropertyBase
        {
        ...
        private class IntProperty : PropertyBase
        {
