...
namespace CodeArt.DomainDriven
{
    ...
    public static class StatusEvent
    {
        ...
        /// <param name="eventType"></param>
        /// <returns></returns>
        private static StatusEventArgs GetEventArgs<T>(StatusEventType eventType = StatusEventType.Any)
             where T : IDomainObject
        {
        ...
        /// <param name="eventType"></param>
        /// <returns></returns>
        private static StatusEventArgs GetEventArgs(Type objectType, StatusEventType eventType = StatusEventType.Any)
        {
            string eventName = GetEventName(objectType, eventType);
