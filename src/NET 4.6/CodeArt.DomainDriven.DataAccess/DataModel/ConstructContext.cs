...
namespace CodeArt.DomainDriven.DataAccess
{
    ...
    public static class ConstructContext
    {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public static object Get(object rootId, object id)
        {
            return Current.Get(rootId, id);
        }
        ...
        private class ConstructContextImpl
        {
            ...
            public void Add(object rootId, object id, object obj)
            {
            ...
            /// <param name="id"></param>
            /// <returns></returns>
            public object Get(object rootId, object id)
            {
                var item = _items.FirstOrDefault((t) =>
                {
                    return t.RootId.Equals(rootId) && t.Id.Equals(id);
                });
